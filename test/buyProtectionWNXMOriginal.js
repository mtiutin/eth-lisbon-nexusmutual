...
contract('Buy Protection Distributor', (accounts) => {
    ...
    it('Create WNXM & Uniswap Pair', async () => {
        ...
        await pool1.buyNXM.sendTransaction(toBN(0),{from:admin, value:toBN(10).mul(decimals)});
    ...
    it('BuyProtection NXM', async () => {
        ...
        if(true){
            ...
            txNXM = await debug( await distributor.buyCoverWNXM(
                coverData.contractAddress,
                coverData.asset,
                amountInWei,
                coverData.period,
            ...
            txNXM = await debug( await distributor.buyCoverNXM(
                coverData.contractAddress,
                coverData.asset,
                amountInWei,
                coverData.period,
